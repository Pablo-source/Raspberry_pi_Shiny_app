...
# FUNCTION 01-02  [Read in Github data as ZIP file]
...
# FUNCTION 02-02 [Update and download data as ZIP file]
...
# 7 PIVOT_LONGER
# We need to change the data structure to group Confirmed, Deaths, Recovered c
